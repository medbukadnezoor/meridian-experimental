...
export function buildConfig(userConfig = {}, env = process.env) {
  ...
  return {
    ...
    screening: {
      ...
      fabriqOhlcvEntryGateKnifeVetoEnabled: s.fabriqOhlcvEntryGateKnifeVetoEnabled ?? u.fabriqOhlcvEntryGateKnifeVetoEnabled ?? true,
      fabriqOhlcvEntryGateRetraceVetoPct: s.fabriqOhlcvEntryGateRetraceVetoPct ?? u.fabriqOhlcvEntryGateRetraceVetoPct ?? -25,
      fabriqOhlcvEntryGateReboundMinPct: s.fabriqOhlcvEntryGateReboundMinPct ?? u.fabriqOhlcvEntryGateReboundMinPct ?? 3,
