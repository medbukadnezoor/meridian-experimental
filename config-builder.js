...
export function buildConfig(userConfig = {}, env = process.env) {
  ...
  return {
    ...
    management: {
      ...
      profitProtectionShadowLoggingEnabled: u.profitProtectionShadowLoggingEnabled ?? isNanocapPreset,
      profitProtectionShadowBotName: u.profitProtectionShadowBotName ?? (String(u.preset ?? "").toLowerCase().includes("nanocap") ? "nanocap" : "meridian"),
      profitProtectionShadowPrimaryPeakPct: u.profitProtectionShadowPrimaryPeakPct ?? 5,
      ...
      ohlcvDrawdownShadowEnabled: u.ohlcvDrawdownShadowEnabled ?? isNanocapPreset,
