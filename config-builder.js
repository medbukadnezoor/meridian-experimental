...
export function buildConfig(userConfig = {}, env = process.env) {
  ...
  return {
    ...
    screening: {
      ...
      criticalThinMcapUsd: s.criticalThinMcapUsd ?? u.criticalThinMcapUsd ?? 300_000,
      criticalThinActiveTvlUsd: s.criticalThinActiveTvlUsd ?? u.criticalThinActiveTvlUsd ?? 5_000,
      criticalThinWatchMcapUsd: s.criticalThinWatchMcapUsd ?? u.criticalThinWatchMcapUsd ?? 500_000,
