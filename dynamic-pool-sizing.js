...
export function buildDynamicPoolSizingDecision(args = {}, runtimeConfig = {}, context = {}) {
  ...
  const decision = {
    ...
    hard_cap_sol: null,
    final_deploy_share_of_active_tvl_pct: null,
  ...
  decision.final_deploy_share_of_active_tvl_pct = finalSizeSol != null
    ? Math.round(((finalSizeSol * solUsd) / activeTvlUsd) * 10000) / 100
    : null;
