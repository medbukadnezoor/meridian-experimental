...
const toolMap = {
  ...
  update_config: ({ changes, reason = "" }) => {
    ...
    const CONFIG_MAP = {
      ...
      profitProtectionShadowLoggingEnabled: ["management", "profitProtectionShadowLoggingEnabled"],
      profitProtectionShadowBotName: ["management", "profitProtectionShadowBotName"],
      profitProtectionShadowPrimaryPeakPct: ["management", "profitProtectionShadowPrimaryPeakPct"],
