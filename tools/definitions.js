...
WARNING: This executes a real on-chain transaction. Check DRY_RUN mode.`,
      parameters: {
        ...
        properties: {
          ...
          mcap: { type: "number", description: "Candidate market cap at deploy time for range-width guard telemetry/enforcement" },
          active_tvl: { type: "number", description: "Candidate active TVL at deploy time for range-width guard telemetry/enforcement" },
          ...
          fee_velocity_usd_per_min: { type: "number", description: "Recent fee velocity in USD per minute at deploy time for dynamic range-width fee-density tightening" },
